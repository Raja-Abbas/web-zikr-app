          ...
          <div className="flex-1 overflow-y-auto flex flex-col items-center justify-center px-4 sm:px-6 py-8 sm:py-8">
            ...
            >
              ...
              <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" />
                  ...
                  {isLogin ? "Login with an e-mail" : "Sign in with an e-mail"}
                </button>
                ...
                >
                  <Image
                    ...
                    height="20"
                  />
                  <span className="pt-[2px]">{isLogin ? "Login with google" : "Sign in with google"}</span>
                </button>
                ...
                >
                  ...
                  <span className="pt-[2px]">{isLogin ? "Login with apple" : "Sign in with apple"}</span>
                </button>
              </div>
            )}
          </div>
