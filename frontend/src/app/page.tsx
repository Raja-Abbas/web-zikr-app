      ...
      {showHomeScreen ? (
        ...
        <div className="w-full max-w-sm space-y-4">
          ...
          <button
            ...
            className="w-full py-4 px-6 bg-transparent border border-cream text-cream rounded-lg hover:bg-cream hover:text-black transition-all duration-300 flex items-center justify-center space-x-3 text-base md:text-lg group"
          >
            <svg className="w-5 h-5 fill-cream group-hover:fill-black transition-colors duration-300" viewBox="0 0 20 20">
          ...
          <button
            ...
            className="w-full py-4 px-6 bg-transparent border border-cream text-cream rounded-lg hover:bg-cream hover:text-black transition-all duration-300 flex items-center justify-center space-x-3 text-base md:text-lg group"
          >
            <svg className="w-5 h-5 fill-cream group-hover:fill-black transition-colors duration-300" viewBox="0 0 24 24">
