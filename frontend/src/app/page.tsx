...
export default function Home() {
  ...
  return (
    <div
      className={`bg-gradient-to-br min-h-full justify-center from-emerald-900 via-slate-900 to-slate-950 flex flex-col`}
    >
      {!validateNavigationState() ? (
        ...
        <div className="flex h-screen flex-col w-full max-w-none">
