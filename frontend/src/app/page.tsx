            ...
            >
              ...
              <div className="w-full max-w-sm space-y-4">
                ...
                <button
                  ...
                  className="w-[235px] cursor-pointer mx-auto py-3 px-6 bg-transparent border border-cream text-cream rounded-[20px] hover:underline font-bold transition-all duration-300 flex items-center justify-center space-x-3 text-base md:text-lg group"
                >
