    ...
    <div className="min-h-screen bg-gradient-to-br from-teal-900 via-slate-900 to-indigo-950 flex flex-col items-center justify-center px-6 py-8">
      ...
      <div className="w-full max-w-sm space-y-4">
        ...
        <button
          ...
          className="w-full py-4 px-6 bg-transparent border border-white text-white rounded-lg hover:bg-white hover:text-gray-900 transition-all duration-300 flex items-center justify-center space-x-3 text-base md:text-lg"
        >
      ...
      {/* Note: This is temporarily showing the auth screen on homepage */}
      <div className="mt-8">
        <p className="text-white text-sm text-center opacity-75">
          This is Screen 1: Registration/Sign-in Selection
        </p>
        <p className="text-white text-xs text-center opacity-50 mt-2">
          (Temporarily displayed on homepage for immediate viewing)
        </p>
      </div>
    </div>
  );
